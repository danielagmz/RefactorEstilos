    ...
    <div class="container read">
        ...
        <main class="content">
            ...
            <div class="busqueda__resultados">
                <article tabindex="0"  tabindex="0" class="article" data-id="24">
                ...
                <article tabindex="0" tabindex="0" class="article" data-id="17">
                    <div class="article__header">
                        <div class="article__icon"></div>
                ...
                <article tabindex="0" tabindex="0" class="article" data-id="15">
                    <div class="article__header">
                        <div class="article__icon"></div>
                ...
                <article tabindex="0" tabindex="0" class="article" data-id="12">
                    <div class="article__header">
                        <div class="article__icon"></div>
