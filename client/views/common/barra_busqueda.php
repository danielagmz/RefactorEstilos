<div class="cabeceras">
   <div class="busqueda-barra content__body--row">
      <input aria-label="search bar" type="text" list="busquedas" id="busqueda-barra__input" name="busqueda-barra__input" placeholder="Filtar por..." class="busqueda-barra__input" autofocus>
